...
export default function CodeExplanation({ concept_description, video_url, github_url }: CodeExplanationProps) {
  return (
    <div className="flex flex-row flex-wrap items-center gap-10 py-24 lg:gap-20 lg:flex-nowrap ">
