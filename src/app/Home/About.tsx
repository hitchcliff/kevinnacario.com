          ...
          <Popup sensor={setClicked}>
            <div className="w-full h-full bg-white">
              ...
              <div className="mt-10 flex flex-row items-center flex-wrap gap-5">
                ...
                <a
                  className="underline text-md text-gray-600"
                  href="https://github.com/hitchcliff/dashboard-laravel"
                >
                  Github
                </a>
              </div>
              <p className="mt-5 italic">
                Try checking my other Fullstack applications as well within my Github repository.
              </p>
            </div>
          </Popup>
        )}
